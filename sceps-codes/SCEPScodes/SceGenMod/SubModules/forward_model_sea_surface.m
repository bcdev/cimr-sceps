%=================================================================
%
% Mscript implementing the SURFEM-Ocean microwave sea surface
...
% the RTTOV v13.2. Here is slightly modified to output the
% imternal emis components.
%
% It can be run as:
%
% (1) Emis calculation:
...
%			surface_ocean( sst, sss, ows, owd, freq, angle, trans)
%        
...
%
%-----------------------------------------------------------------------------
% Project:	  A Reference Quality Model For Ocean Surface 
%                 Emissivity And Backscatter From The Microwave 
%                 To The Infrared
%                 https://www.issibern.ch/teams/oceansurfemiss/
% Contact:	  lise.kilic@obspm.fr 
% Reference:	  https://nwp-saf.eumetsat.int/publications/
%                 vs_reports/nwpsaf-ec-vs-060.pdf
%-----------------------------------------------------------------------------
% Update: 2024-02-21 CJ outputting more variables.

function [e, e_all, r, e_dt, e_ds, e_dw ] = forward_model_sea_surface( sst, sss, ows, owd, freq, angle, trans)
