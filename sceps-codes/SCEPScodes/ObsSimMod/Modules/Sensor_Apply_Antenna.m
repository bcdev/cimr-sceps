...
dircimrProject = [ E2E_HOME, '/SCEPScodes/ObsSimMod/Modules' ];
...
%=== Calculating center dates for ascending and descending orbit selection


lon  = ncread( scene_toa_file, 'longitude' );
lat  = ncread( scene_toa_file, 'latitude' );
...
if strcmp( orbit_type, 'asc' )
  [date_center, ~] = cimr_find_closest_time_latlon(clat, clon, orbit_file_name);
elseif strcmp( orbit_type, 'des' )
  [~, date_center] = cimr_find_closest_time_latlon(clat, clon, orbit_file_name);
end
