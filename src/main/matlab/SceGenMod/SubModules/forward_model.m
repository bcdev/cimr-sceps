...
function [R,y,J] = forward_model( Q, R, x, iter )
...
[ y, R.emis ] = forward_model_freq( Q.atmos_input, Q.surf_input, Q.dir_input, Q.sensor_input.F, Q.sensor_input.ZA, Q.sensor_input.AA, Q.sensor_input.H, Q.sensor_input.VPOL, Q.sensor_input.HPOL, Q.sensor_input.TOA);
...
function [ y, emis ] = forward_model_freq( atmos_input, surf_input, dir_input, freqs, zangle, aangle, height, do_vpol, do_hpol, do_toa )
...
for f = 1:nf
  ...
  [ bts, emi ]  = forward_model_core( atmos_input, surf_input, sensor_input, dir_input ); 
